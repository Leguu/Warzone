...
void BenevolentPlayer::issueCardOrder() {
  ...
  std::map<std::string, int> cardNameMap = {{"Airlift", 0}, {"NegotiateCard", 1}};
  ...
  switch (cardIndex) {
    ...
    default:
      throw InvalidCardException(randomCardName + " is not a legal card for this (benevolent) player strategy.");
  }
}
